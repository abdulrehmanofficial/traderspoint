...
<h3 style="font-family: 'Passion One', cursive;" class="text-center alert alert-info">Fabric Orders Approvals/Notifications</h3>
<br />
...
<?php
	$email=$_SESSION['purchaser'];
	 require"connect_db.php";
	$query="select * from fabricnotifications WHERE purchaserEmail='$email' AND task='approved'";
    $data=mysqli_query($connect,$query);
...
<td><a href="CompletedOrder.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Completed</a>
<a href="NotCompletedOrder.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Not Completed</a></td>
</tr>
	  <?php
	}
?>
