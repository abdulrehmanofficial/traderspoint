  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li><a href="FabricDashboard.php#top">Home</a></li>
        <li><a href="seeMyFabricAd.php#top">See My Existing Ads</a></li>
		<li><a href="fabricOrderHistory.php#top">Order History</a></li>
		
    </ul>
	<ul class="nav navbar-nav navbar-right">
	<?php 
	 require"connect_db.php";
	$query="SELECT * from fabricnotifications WHERE status='not read'";
	$data=mysqli_query($connect,$query);
	$nots=mysqli_num_rows($data);
	?>
	<li><a href="fabricnotifications.php#top"><span class="glyphicon glyphicon-globe"></span>&nbsp;<b style="color:white;font-size:22px"><?php echo $nots; ?></b> Notifications</a></li>
         <li>
