...
header('Location: https://traders.houseofsoftwares.com/customer');
die();
exit();
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li><a href="index.php">Home</a></li>
        <li><a href="about.php#top">About Us</a></li>
        <li class="dropdown">
          <a  class="dropdown-toggle" data-toggle="dropdown" href="registerInChamber.php">Register in Chamber <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="nameCheck.php#top">Name Availability Check in Chamber</a></li>
            <li><a href="registerInChamber.php#top">Registration in Chamber</a></li>
          </ul>
        </li>
		<li><a href="login.php#top">Manufacturing Orders</a></li>
		<li><a href="FabricSales.php#top">Fabric Sales & Purchase</a></li>
		<li><a href="WorkingUnits.php#top">Working Units</a></li>
