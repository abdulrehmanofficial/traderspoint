...
<td><a href="CompletedWUorder.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Completed</a> <a href="NotCompletedWUorder.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Not Completed</a></td>
</tr>
	<?php
	}
?>
