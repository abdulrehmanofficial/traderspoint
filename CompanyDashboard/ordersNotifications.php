...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
	...
	$query="select * from chat WHERE toperson='$user' AND readStatus='-1' ORDER BY id DESC";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Order Notifications</li>
      </ol>
      <div class="card mb-3">
...
<th>Action</th>
	  ...
	  $query2="select * from orderData WHERE orderedTo='$orderedTo' AND orderStatus='No'";
...
{
?>
<td><a href="../<?php echo $row2['pic']; ?>">Download Attachment</a></td>
<?php }
else{
...
<td><a class="btn btn-success" href="approveOrder.php?id=<?php echo $row2['id']; ?>&address=<?php echo $row2['orderedBy']; ?>">Approve</a>
<a class="btn btn-danger" href="disapproveOrder.php?id=<?php echo $row2['id']; ?>&address=<?php echo $row2['orderedBy']; ?>">Disapprove</a>
</td>
</tr>
	  <?php
	  }
