...
if(isset($_POST['changePass']))
{
	...
	{	
		...
		$preQuery="SELECT pass from registerfororders WHERE email='$email'";
		$dataa=mysqli_query($connect,$preQuery);
	  ...
	  if($oldpassword==$old)
	  {
			...
			$query="UPDATE registerfororders SET pass='$newPass' WHERE email='$email'";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">All Recently Contacted Vendors</li>
      </ol>
      <!-- Area Chart Example-->
      <div class="card mb-3">
	  
        <h4 class="alert alert-success">Change Your Password !!</h4>
		<form method="post">
		<input style="margin-bottom:7px" class="form-control" type="password" name="oldpass" placeholder="Enter Your Old Password" />
		<input style="margin-bottom:7px" class="form-control" type="password" name="newpass" placeholder="Enter New Password" />
		<input style="margin-bottom:7px" class="form-control" type="password" name="newpass2" placeholder="Confirm New Password" />
		<center><input type="submit" class="btn btn-success" name="changePass" value="Change Password"/></center>
		</form>
