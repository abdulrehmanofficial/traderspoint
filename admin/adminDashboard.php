...
$(document).ready(function(){
 ...
 <h1 class="text-center">Company Registration Approvals</h1>
...
$query="select * from registerfororders";
...
while($row=mysqli_fetch_array($data))
{
	...
	{		
 ?>
 <tr style="color:white;background-color:#C78382" class="alert alert-danger">
...
<td><a class="btn btn-success" href="approve.php?id=<?php echo $row['id']; ?>&email=<?php echo $row['email'];?>">Approve</a></td>
</tr>
<?php
	}
	else
