...
<nav id="mNavbar" class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
	  ...
	  <li><a href="../SurgicalExporters">Surgical Exporters</a></li>
	  <li><a href="../SportsExporters">Sports Exporters</a></li>
	  <li><a href="../GarmentsExporters	">Garments Exporters</a></li>
	  <li>
	  <form action="../Search/index.php" class="navbar-form navbar-left" method="post" role="search">
